...
export default {
  ...
  toggleDocks(show) {
    if (show) {
      this.toggleLeftDock &&
        this.showIfHasContent(atom.workspace.getLeftDock());
      this.toggleRightDock &&
        this.showIfHasContent(atom.workspace.getRightDock());
      this.toggleBottomDock &&
        this.showIfHasContent(atom.workspace.getBottomDock());
    } else {
  ...
  showIfHasContent(dock) {
    dock.getPaneItems().length && dock.show();
  }
};
